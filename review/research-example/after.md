...
[Examine Assumptions](#assumptions) · [STEM Adventure Games](#stem-chat) · [Compare Wikipedia Revisions](#wikipedia-revisions) · [Check Game Sources](#stem-sources) · [Advanced Game Instructions](#stem-system)

### Compare Wikipedia Revisions



Use provided before-and-after excerpts from Wikipedia’s academic freedom article to classify a change and explain it with quoted evidence.



[Model settings](examples/research/model-card.md) · [Sample revisions](examples/research/sample-revisions.md) · [Download prompt](examples/research/system-prompt.txt)
